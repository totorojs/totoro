        ...
        _.each(reports, function(report){
            ...
            switch(action){
                case 'addLabor':
                    ...
                    logger.debug('add browser: ' + id + ' [' + ua + ']')
                    break
                case 'removeLabor':
                    var id = browsers[platform].id
                    var ua = browsers[platform].ua
                    browsers[platform] = undefined
                    logger.debug('remove browser: ' + id + ' [' + ua + ']')
                    break
                case 'pass':
                case 'pending':
                case 'fail':
                    var browser = browsers[platform]
                    browser.reports.push(report)
                    print(
...
Client.prototype.printResults = function(){
    ...
    println()
    _.each(browsers, function(browser, platform){
        println()
        if(browser){
            var ua = browser.ua
            var reports =  browser.reports
